      ...
      <div class="backpack-body">
        ...
        <div class="backpack-left">
          ...
          >
            <!-- 物品简略图标 -->
            <!-- 生命浆果：三个红色重叠圆点 -->
            <div v-if="backpack.getSlotItem(i - 1) && backpack.getSlotItem(i - 1).name.includes('生命浆果')" class="slot-icon slot-icon-lifeberry">
            ...
            <!-- 魔力浆果：三个蓝色重叠椭圆 -->
            <div v-else-if="backpack.getSlotItem(i - 1) && backpack.getSlotItem(i - 1).name.includes('魔力浆果')" class="slot-icon slot-icon-manaberry">
            ...
            <!-- 已佩戴标记 -->
            <span v-if="backpack.getSlotItem(i - 1) && backpack.getSlotItem(i - 1).equipped" class="slot-equipped-badge">已佩戴</span>
            <!-- 物品数量角标 -->
            <span v-if="backpack.getSlotItem(i - 1) && !backpack.getSlotItem(i - 1).equipped" class="slot-qty">x{{ backpack.getSlotItem(i - 1).quantity }}</span>
          </div>
        </div>
          ...
          <div class="detail-info">
            <template v-if="backpack.selectedItem">
              ...
              <div class="detail-row1">
                <span class="detail-name" :style="{ color: backpack.rarityColor(backpack.selectedItem.rarity) }">
                  {{ backpack.selectedItem.name }}
                </span>
                <span class="detail-id" :style="{ color: backpack.rarityColor(backpack.selectedItem.rarity) }">
                  NO.{{ String(backpack.selectedItem.itemId).padStart(2, '0') }}
                </span>
                <span class="detail-qty" :style="{ color: backpack.rarityColor(backpack.selectedItem.rarity) }">
              ...
              <div class="detail-lore">
                "{{ backpack.selectedItem.loreDesc }}"
              </div>
            </template>
            <template v-else>
