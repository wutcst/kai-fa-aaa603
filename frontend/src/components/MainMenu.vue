      ...
      <div v-if="showAbout" class="about-overlay" @click.self="showAbout = false">
        <div class="about-panel">
          ...
          <div class="about-content">
            ...
            <p>
              你，一位勇敢的探险者，将穿越变幻莫测的迷宫，<br />与神秘的怪物战斗，收集强大的魔法物品，<br />揭示隐藏在废墟中的真相。
            </p>
...
<style scoped>
  ...
  .menu-overlay {
    ...
    background:
      ...
      radial-gradient(ellipse at 50% 120%, rgba(80, 40, 15, 0.3) 0%, transparent 70%);
    pointer-events: none;
  }
  ...
  .game-title {
    ...
    /* 外层光晕 */
      ...
      /* 亮面高光 */ 0 1px 0 rgba(255, 240, 200, 0.7),
      0 2px 0 rgba(220, 180, 80, 0.5),
      /* 暗部凹陷 */ 0 -1px 0 rgba(60, 30, 5, 0.6),
